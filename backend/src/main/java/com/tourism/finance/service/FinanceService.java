...
public class FinanceService {
    ...
    @Autowired
    private FinancialReportRepository reportRepo;
    @Autowired
    private PayrollPaymentRepository payrollRepo;
    @Autowired
    private ServiceProviderPaymentRepository providerPaymentRepo;
    ...
    public Revenue saveRevenue(Revenue r) {
    ...
    public FinancialTransaction saveTransaction(FinancialTransaction t) {
    ...
    // ── Payroll ──
    public List<PayrollPayment> getAllPayrolls() {
        return payrollRepo.findAll();
    }

    public List<PayrollPayment> getPayrollsByEmployee(Long employeeId) {
        return payrollRepo.findByEmployeeId(employeeId);
    }

    public PayrollPayment savePayroll(PayrollPayment p) {
    ...
    // ── Provider Payments ──
    public List<ServiceProviderPayment> getAllProviderPayments() {
        return providerPaymentRepo.findAll();
    }
    ...
    public ServiceProviderPayment saveProviderPayment(ServiceProviderPayment p) {
        return providerPaymentRepo.save(p);
    }

    public void deleteProviderPayment(Long id) {
        providerPaymentRepo.deleteById(id);
    }
}
